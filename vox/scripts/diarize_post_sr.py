...
if __name__ == "__main__":
    ...
    parser.add_argument("reco_file", type=str, default="../scratch/transcripts/tiny.en-diarize_postsr/earnings21-4341191/earnings21-4341191-tiny.en.json")
    parser.add_argument("--num_speakers", type=int, default=5)
    parser.add_argument("--output_dir", type=str, default=None)
    args = parser.parse_args()

    output_dir = Path(args.reco_file).parent if args.output_dir is None else Path(args.output_dir)
    ...
    output_file = output_dir / Path(args.reco_file).name.replace(".json", f"_drzpostsr_{args.num_speakers}.json")
